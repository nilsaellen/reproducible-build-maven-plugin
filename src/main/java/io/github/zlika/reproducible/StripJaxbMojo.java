...
{
    /**
     * Default sentence used to identify a file generated bys JAXB xjc tool.
     */
    public static final String DEFAULT_IDENTIFICATION_SENTENCE = "JavaTM Architecture for XML Binding (JAXB)";
    ...
    /**
     * Sentence which allow to identify a file generated by the JAXB xjc tool.
     * Default value is : "JavaTM Architecture for XML Binding" which is the
     * sentence written by jaxb2-maven-plugin. When using the maven-jaxb2-plugin the
     * sentence is another one. This configuration allow to adapt the recognition
     * to aligned with the file generator instance.
     */
    @Parameter(defaultValue = DEFAULT_IDENTIFICATION_SENTENCE,
            property = "reproducible.identificationSentence")
    private String identificationSentence;
    ...
    private void fix() throws MojoExecutionException
    {
        ...
        final JaxbObjectFactoryFixer objectFactoryFixer = new JaxbObjectFactoryFixer(identificationSentence, charset);
    ...
    private boolean isJaxbFile(List<String> lines)
    {
        return lines.size() > JAXB_FILE_TIMESTAMP_LINE_NUMBER
                ...
                && lines.get(JAXB_FILE_JAXB_COMMENT_LINE_NUMBER)
                    .contains(identificationSentence)
