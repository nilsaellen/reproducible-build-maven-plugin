...
public final class StripJaxbMojo extends AbstractMojo
{
    ...
    /**
     * The implementation of xjc JAXB generator for which files must be stripped.
     * Default value is GLASSFISH.
     */
    @Parameter(defaultValue = "GLASSFISH", property = "reproducible.xjcGenerator")
    private XjcGenerator xjcGenerator;
    ...
    private String getRelyingCommentText()
    {
        ...
        {
            return xjcGenerator.getRelyingCommentText();
        }
    }
    ...
    {
        /**
         * Glassfish implmentation of XJC, used for example in mojohaus jaxb2-maven-plugin.
         */
        GLASSFISH("JavaTM Architecture for XML Binding (JAXB)"),

        /**
         * Eclipse implementation of XJC, used in for example in jvnet maven-jaxb2-plugin.
         */
        ECLIPSE("Eclipse Implementation of JAXB");
